 ...
 */
export type OctopusCommand = SyncStateCommand | ExecuteActionCommand | UpdatePolicyCommand | ShowUICommand | ActionResultCommand | DataChangeCommand | ChatResponseCommand | ChatToolCallCommand | ChatToolResultCommand | ChatSyncCommand;
