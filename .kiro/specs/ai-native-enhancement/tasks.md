...
- [x] 4. 实现阻塞解决服务
  - [x] 4.1 创建 blocker-resolver.service.ts
...
- [x] 5. Checkpoint - 资源层和阻塞服务完成
  - 确保所有资源端点可访问，阻塞服务正常工作

- [x] 6. 实现智能任务分解服务
  - [x] 6.1 创建 task-decomposer.service.ts
...
- [x] 7. 实现智能建议引擎
  - [x] 7.1 创建 smart-suggestion.service.ts
    - 实现 `getNextTaskSuggestion` 基于优先级、截止日期、目标关联排序
    - 实现综合评分算法
    - _Requirements: 3.1, 3.2_
  - [x] 7.2 实现空闲检测和 Airlock 建议
...
- [x] 11. 实现进度分析器增强
  - [x] 11.1 扩展 progress-analyzer.service.ts
...
- [x] 12. Checkpoint - 上下文和分析服务完成
  - 确保上下文提供和进度分析正常工作

- [x] 13. 实现自然语言解析器
  - [x] 13.1 创建 nl-parser.service.ts
...
- [x] 14. 实现事件订阅系统
  - [x] 14.1 创建 mcp-event.service.ts
...
- [x] 17. E2E 测试
  - [x] 17.1 编写 MCP 资源 E2E 测试
    - 测试所有新增资源端点
    - 验证数据结构和响应格式
    - _Requirements: 1.1, 1.2, 1.3, 1.4_
  - [x] 17.2 编写 MCP 工具 E2E 测试
    - 测试批量更新、模板创建、依赖分析、每日总结
    - 验证审计日志记录
    - _Requirements: 4.1, 4.2, 4.3, 4.4, 4.5_
  - [x] 17.3 编写事件订阅 E2E 测试
    - 测试订阅、事件接收、历史查询
